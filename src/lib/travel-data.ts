...
export const TRIP_TYPES: TripTypeOption[] = [
  {
    ...
    label: "National Trip",
    emoji: "🏠",
    description: "Travel within your own country — from city to city with local transport, realistic drive times, and expenses in your local currency.",
  ...
  },
  {
    ...
    emoji: "🌍",
    description: "Plan a trip to any foreign country — with visa reminders, flight times, and costs in USD plus the local currency.",
  ...
  },
  {
    ...
    emoji: "🗺️",
    description: "Combine 2–5 countries in one journey — with inter-country transport, per-country budgets, and a combined day-by-day itinerary.",
